...
final class RegisterViewController: UIViewController {
    ...
    @IBAction func registerTapped(_ sender: UIButton) {
        ...
        guard !fullName.isEmpty else { shakeRecognize(nameTF, "Please enter your name"); return }
        ...
        Auth.auth().createUser(withEmail: email, password: pass) { [weak self] result, error in
            ...
            let data: [String: Any] = [
                "uid": uid,
                "fullName": fullName,                         // ✅ unified field
                "email": email,
                "phone": "",                                  // ✅ keep for edit profile later
                "role": self.role,                            // admin / ngo / donor
                "status": "active",                           // ✅ important for routing
